...
compile_static=" \
nvcc -rdc=true -ccbin g++ -gencode=$NVCC_GENCODE -I \
$NVSHMEM_HOME/include:$MPI_HOME/include unique-id-Attribute-Based-Initialization-Example.cu -o \
unique-id-Attribute-Based-Initialization-Example.out -L $NVSHMEM_HOME/lib:$MPI_HOME/lib \
...
unique-id-Attribute-Based-Initialization-Example.cu \
-o unique-id-Attribute-Based-Initialization-Example.out \
